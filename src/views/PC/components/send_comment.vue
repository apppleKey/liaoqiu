  ...
  <div class="replaycon1 send_commemnt_cnpt" >
    ...
    <div class="replay1_right">
      ...
      <div class="commemnt_tools">
        <span class="iconfont icon-xiaolian face_btn" @click="showPanle($event)"> <span style="margin-left:10px;color:gray">添加表情</span>
        ...
        <div class="opration_btns">
          ...
          <span style="margin-right:40px;font-weight: 400;font-size: 20px;color:gray">最多120个字</span>
